...
// Sélectionnez les candidats dont la colonne "nomine" est égale à "producteur_contenu"
$query = "SELECT candidat.id, candidat.nom_prenom, candidat.photo, SUM(vote.points) AS total_points
          ...
          WHERE candidat.nomine = 'producteur_contenu'
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<div class='count'>$total_points points</div>";
        echo "<form action='vote/vote.php' method='POST'>";
